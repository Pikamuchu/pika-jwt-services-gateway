...
var SwaggerResource = function(resourceObj, api) {
  ...
  if ((resourceObj.apis != null) && (this.api.resourcePath != null)) {
    ...
    if (this.path.substring(0, 4) === 'http') {
      ...
      this.url = location.origin + this.api.basePath + this.path.replace('{format}', 'json');
    }
...
SwaggerOperation.prototype.urlify = function(args) {
  var url = (this.resource.basePath.indexOf('http') !== 0) ? location.origin + this.resource.basePath + this.pathJson() : this.resource.basePath + this.pathJson();
